...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'contacts', 'email', self.gf('django.db.models.fields.EmailField')(max_length=254))

        # Changing field 'Relation.invoice_email'
        db.alter_column(u'relations', 'invoice_email', self.gf('django.db.models.fields.EmailField')(max_length=254))

        # Changing field 'Relation.email'
        db.alter_column(u'relations', 'email', self.gf('django.db.models.fields.EmailField')(max_length=254))
    def backwards(self, orm):

        # Changing field 'Contact.email'
        db.alter_column(u'contacts', 'email', self.gf('django.db.models.fields.CharField')(max_length=180))

        # Changing field 'Relation.invoice_email'
        db.alter_column(u'relations', 'invoice_email', self.gf('django.db.models.fields.CharField')(max_length=180))

        # Changing field 'Relation.email'
        db.alter_column(u'relations', 'email', self.gf('django.db.models.fields.CharField')(max_length=180))
    models = {
        'accounting.account': {
