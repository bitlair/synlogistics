...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PurchaseOrderItem.purchase_price_currency'
        db.add_column(u'purchase_order_data', 'purchase_price_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='EUR', max_length=3),
                      keep_default=False)


        # Changing field 'PurchaseOrderItem.purchase_price'
        db.alter_column(u'purchase_order_data', 'purchase_price', self.gf('djmoney.models.fields.MoneyField')(decimal_places=5, max_digits=25, null=True, default_currency='EUR'))
        # Adding field 'InternalOrder.purchase_price_indication_currency'
        db.add_column(u'internal_order', 'purchase_price_indication_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='EUR', max_length=3),
                      keep_default=False)

        # Adding field 'InternalOrder.selling_price_currency'
        db.add_column(u'internal_order', 'selling_price_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='EUR', max_length=3),
                      keep_default=False)


        # Changing field 'InternalOrder.purchase_price_indication'
        db.alter_column(u'internal_order', 'purchase_price_indication', self.gf('djmoney.models.fields.MoneyField')(decimal_places=5, max_digits=25, null=True, default_currency='EUR'))

        # Changing field 'InternalOrder.selling_price'
        db.alter_column(u'internal_order', 'selling_price', self.gf('djmoney.models.fields.MoneyField')(decimal_places=5, max_digits=25, null=True, default_currency='EUR'))
        # Adding field 'ProductSellingprice.price_currency'
        db.add_column(u'product_sellingprices', 'price_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='EUR', max_length=3),
                      keep_default=False)


        # Changing field 'ProductSellingprice.price'
        db.alter_column(u'product_sellingprices', 'price', self.gf('djmoney.models.fields.MoneyField')(decimal_places=5, max_digits=25, null=True, default_currency='EUR'))
        # Adding field 'InventoryItem.value_currency'
        db.add_column(u'inventory_data', 'value_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='EUR', max_length=3),
                      keep_default=False)


        # Changing field 'InventoryItem.value'
        db.alter_column(u'inventory_data', 'value', self.gf('djmoney.models.fields.MoneyField')(decimal_places=5, max_digits=25, null=True, default_currency='EUR'))
    def backwards(self, orm):
        # Deleting field 'PurchaseOrderItem.purchase_price_currency'
        db.delete_column(u'purchase_order_data', 'purchase_price_currency')


        # Changing field 'PurchaseOrderItem.purchase_price'
        db.alter_column(u'purchase_order_data', 'purchase_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=5))
        # Deleting field 'InternalOrder.purchase_price_indication_currency'
        db.delete_column(u'internal_order', 'purchase_price_indication_currency')

        # Deleting field 'InternalOrder.selling_price_currency'
        db.delete_column(u'internal_order', 'selling_price_currency')


        # Changing field 'InternalOrder.purchase_price_indication'
        db.alter_column(u'internal_order', 'purchase_price_indication', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=5))

        # Changing field 'InternalOrder.selling_price'
        db.alter_column(u'internal_order', 'selling_price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=5))
        # Deleting field 'ProductSellingprice.price_currency'
        db.delete_column(u'product_sellingprices', 'price_currency')


        # Changing field 'ProductSellingprice.price'
        db.alter_column(u'product_sellingprices', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=5))
        # Deleting field 'InventoryItem.value_currency'
        db.delete_column(u'inventory_data', 'value_currency')


        # Changing field 'InventoryItem.value'
        db.alter_column(u'inventory_data', 'value', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=5))
    models = {
        'accounting.account': {
        ...
        'main.inventoryitem': {
            ...
            'value': ('djmoney.models.fields.MoneyField', [], {'decimal_places': '5', 'default': "'0.0'", 'max_digits': '25', 'blank': 'True', 'null': 'True', 'default_currency': "'EUR'"}),
            'value_currency': ('djmoney.models.fields.CurrencyField', [], {'default': "'EUR'", 'max_length': '3'})
        },
        'main.item': {
        ...
        'main.productsellingprice': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'price': ('djmoney.models.fields.MoneyField', [], {'decimal_places': '5', 'default': "'0.0'", 'max_digits': '25', 'blank': 'True', 'null': 'True', 'default_currency': "'EUR'"}),
