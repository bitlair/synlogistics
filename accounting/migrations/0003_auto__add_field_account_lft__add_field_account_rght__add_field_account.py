...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.lft'
        db.add_column(u'accounts', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Account.rght'
        db.add_column(u'accounts', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Account.tree_id'
        db.add_column(u'accounts', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Account.level'
        db.add_column(u'accounts', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


        # Changing field 'Account.parent'
        db.alter_column(u'accounts', 'parent_id', self.gf('mptt.fields.TreeForeignKey')(null=True, to=orm['accounting.Account']))
    def backwards(self, orm):
        # Deleting field 'Account.lft'
        db.delete_column(u'accounts', 'lft')

        # Deleting field 'Account.rght'
        db.delete_column(u'accounts', 'rght')

        # Deleting field 'Account.tree_id'
        db.delete_column(u'accounts', 'tree_id')

        # Deleting field 'Account.level'
        db.delete_column(u'accounts', 'level')


        # Changing field 'Account.parent'
        db.alter_column(u'accounts', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['accounting.Account']))
    models = {
        'accounting.account': {
