...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.invoice_number'
        db.alter_column(u'transactions', 'invoice_number', self.gf('django.db.models.fields.CharField')(default='', max_length=45))
    def backwards(self, orm):

        # Changing field 'Transaction.invoice_number'
        db.alter_column(u'transactions', 'invoice_number', self.gf('django.db.models.fields.CharField')(max_length=45, null=True))
    models = {
        'accounting.account': {
