...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account._balance'
        db.alter_column(u'accounts', '_balance', self.gf('djmoney.models.fields.MoneyField')(max_digits=25, decimal_places=5, default_currency='EUR'))
        ...
        db.alter_column(u'transactions', 'amount', self.gf('djmoney.models.fields.MoneyField')(decimal_places=5, max_digits=25, null=True, default_currency='EUR'))
    def backwards(self, orm):
        ...
        # Changing field 'Account._balance'
        db.alter_column(u'accounts', '_balance', self.gf('django.db.models.fields.DecimalField')(max_digits=25, decimal_places=5))
        # Deleting field 'Transaction.amount_currency'
        db.delete_column(u'transactions', 'amount_currency')


        # Changing field 'Transaction.amount'
        db.alter_column(u'transactions', 'amount', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=25, decimal_places=5))
    models = {
        'accounting.account': {
        ...
        'accounting.transaction': {
            ...
            'invoice_number': ('django.db.models.fields.CharField', [], {'max_length': '45', 'blank': 'True'}),
