...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InvoiceItem.period'
        db.alter_column(u'invoice_data', 'period', self.gf('django.db.models.fields.CharField')(default='', max_length=30))
    def backwards(self, orm):

        # Changing field 'InvoiceItem.period'
        db.alter_column(u'invoice_data', 'period', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
    models = {
        'accounting.account': {
