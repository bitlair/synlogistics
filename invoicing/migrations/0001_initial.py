...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'invoices', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoices', to=orm['main.Relation'])),
            ('date', self.gf('django.db.models.fields.DateField')(db_index=True)),
            ('booking_period', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.BookingPeriod'])),
            ('number', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('full_invoice_no', self.gf('django.db.models.fields.CharField')(max_length=25, db_index=True)),
        ))
        db.send_create_signal('invoicing', ['Invoice'])

        # Adding model 'InvoiceItem'
        db.create_table(u'invoice_data', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['invoicing.Invoice'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoice_data', null=True, to=orm['main.Item'])),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoice_data', to=orm['main.Product'])),
            ('period', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('count', self.gf('django.db.models.fields.IntegerField')()),
            ('amount', self.gf('django.db.models.fields.DecimalField')(max_digits=25, decimal_places=5)),
            ('vat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting.Vat'], null=True)),
        ))
        db.send_create_signal('invoicing', ['InvoiceItem'])

        # Adding model 'Subscription'
        db.create_table(u'subscriptions', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriptions', to=orm['main.Product'])),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriptions', to=orm['main.Relation'])),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('discount', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=9, decimal_places=5)),
            ('invoiced_until_date', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('intervals_per_invoice', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('extra_info', self.gf('django.db.models.fields.TextField')()),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('invoicing', ['Subscription'])

        # Adding model 'TimeBillingRate'
        db.create_table('invoicing_timebillingrate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('rate', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('vat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting.Vat'])),
        ))
        db.send_create_signal('invoicing', ['TimeBillingRate'])

        # Adding model 'TimeKeepingEntry'
        db.create_table('invoicing_timekeepingentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('rate', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoicing.TimeBillingRate'])),
            ('customer', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.Relation'])),
            ...
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['invoicing.Invoice'], null=True, blank=True)),
        ))
        db.send_create_signal('invoicing', ['TimeKeepingEntry'])

        # Adding model 'SimpleInvoiceItem'
        db.create_table('invoicing_simpleinvoiceitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('invoice', self.gf('django.db.models.fields.related.ForeignKey')(related_name='simple_items', to=orm['invoicing.Invoice'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('count', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2)),
            ('price', self.gf('django.db.models.fields.DecimalField')(max_digits=25, decimal_places=5)),
            ('vat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting.Vat'], null=True)),
        ))
        db.send_create_signal('invoicing', ['SimpleInvoiceItem'])

    def backwards(self, orm):
        # Deleting model 'Invoice'
        db.delete_table(u'invoices')

        # Deleting model 'InvoiceItem'
        db.delete_table(u'invoice_data')

        # Deleting model 'Subscription'
        db.delete_table(u'subscriptions')

        # Deleting model 'TimeBillingRate'
        db.delete_table('invoicing_timebillingrate')

        # Deleting model 'TimeKeepingEntry'
        db.delete_table('invoicing_timekeepingentry')

        # Deleting model 'SimpleInvoiceItem'
        db.delete_table('invoicing_simpleinvoiceitem')
    ...
    models = {
        ...
        'invoicing.subscription': {
            ...
            'discount': ('django.db.models.fields.DecimalField', [], {'default': '0.0', 'max_digits': '9', 'decimal_places': '5'}),
