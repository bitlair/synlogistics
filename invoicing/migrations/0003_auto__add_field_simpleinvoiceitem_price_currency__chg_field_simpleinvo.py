...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SimpleInvoiceItem.price_currency'
        db.add_column('invoicing_simpleinvoiceitem', 'price_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='EUR', max_length=3),
                      keep_default=False)


        # Changing field 'SimpleInvoiceItem.price'
        db.alter_column('invoicing_simpleinvoiceitem', 'price', self.gf('djmoney.models.fields.MoneyField')(max_digits=25, decimal_places=5, default_currency='EUR'))
        # Adding field 'InvoiceItem.amount_currency'
        db.add_column(u'invoice_data', 'amount_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='EUR', max_length=3),
                      keep_default=False)


        # Changing field 'InvoiceItem.amount'
        db.alter_column(u'invoice_data', 'amount', self.gf('djmoney.models.fields.MoneyField')(max_digits=25, decimal_places=5, default_currency='EUR'))
        # Adding field 'Subscription.discount_currency'
        db.add_column(u'subscriptions', 'discount_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='EUR', max_length=3),
                      keep_default=False)


        # Changing field 'Subscription.discount'
        db.alter_column(u'subscriptions', 'discount', self.gf('djmoney.models.fields.MoneyField')(max_digits=9, decimal_places=5, default_currency='EUR'))
        # Adding field 'TimeBillingRate.rate_currency'
        db.add_column('invoicing_timebillingrate', 'rate_currency',
                      self.gf('djmoney.models.fields.CurrencyField')(default='EUR', max_length=3),
                      keep_default=False)


        # Changing field 'TimeBillingRate.rate'
        db.alter_column('invoicing_timebillingrate', 'rate', self.gf('djmoney.models.fields.MoneyField')(max_digits=12, decimal_places=2, default_currency='EUR'))
    def backwards(self, orm):
        # Deleting field 'SimpleInvoiceItem.price_currency'
        db.delete_column('invoicing_simpleinvoiceitem', 'price_currency')


        # Changing field 'SimpleInvoiceItem.price'
        db.alter_column('invoicing_simpleinvoiceitem', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=25, decimal_places=5))
        # Deleting field 'InvoiceItem.amount_currency'
        db.delete_column(u'invoice_data', 'amount_currency')


        # Changing field 'InvoiceItem.amount'
        db.alter_column(u'invoice_data', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=25, decimal_places=5))
        # Deleting field 'Subscription.discount_currency'
        db.delete_column(u'subscriptions', 'discount_currency')


        # Changing field 'Subscription.discount'
        db.alter_column(u'subscriptions', 'discount', self.gf('django.db.models.fields.DecimalField')(max_digits=9, decimal_places=5))
        # Deleting field 'TimeBillingRate.rate_currency'
        db.delete_column('invoicing_timebillingrate', 'rate_currency')


        # Changing field 'TimeBillingRate.rate'
        db.alter_column('invoicing_timebillingrate', 'rate', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=2))
    models = {
        'accounting.account': {
            'Meta': {'ordering': "['number']", 'object_name': 'Account', 'db_table': "u'accounts'"},
            '_balance': ('djmoney.models.fields.MoneyField', [], {'default': '0.0', 'max_digits': '25', 'decimal_places': '5', 'default_currency': "'EUR'"}),
            '_balance_currency': ('djmoney.models.fields.CurrencyField', [], {'default': "'EUR'", 'max_length': '3'}),
        ...
        'invoicing.invoiceitem': {
            ...
            'amount': ('djmoney.models.fields.MoneyField', [], {'default': "'0.0'", 'max_digits': '25', 'decimal_places': '5', 'default_currency': "'EUR'"}),
            ...
            'period': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
        ...
        'invoicing.simpleinvoiceitem': {
            'Meta': {'object_name': 'SimpleInvoiceItem'},
            'count': ('django.db.models.fields.DecimalField', [], {'max_digits': '12', 'decimal_places': '2'}),
            'description': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'simple_items'", 'to': "orm['invoicing.Invoice']"}),
            'price': ('djmoney.models.fields.MoneyField', [], {'default': "'0.0'", 'max_digits': '25', 'decimal_places': '5', 'default_currency': "'EUR'"}),
            'price_currency': ('djmoney.models.fields.CurrencyField', [], {'default': "'EUR'", 'max_length': '3'}),
            'vat': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounting.Vat']", 'null': 'True'})
        },
        'invoicing.subscription': {
            'Meta': {'object_name': 'Subscription', 'db_table': "u'subscriptions'"},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subscriptions'", 'to': "orm['main.Relation']"}),
            'discount': ('djmoney.models.fields.MoneyField', [], {'default': '0.0', 'max_digits': '9', 'decimal_places': '5', 'default_currency': "'EUR'"}),
            'discount_currency': ('djmoney.models.fields.CurrencyField', [], {'default': "'EUR'", 'max_length': '3'}),
            'end_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'extra_info': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intervals_per_invoice': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'invoiced_until_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subscriptions'", 'to': "orm['main.Product']"}),
            'start_date': ('django.db.models.fields.DateTimeField', [], {})
        },
        'invoicing.timebillingrate': {
            'Meta': {'object_name': 'TimeBillingRate'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'rate': ('djmoney.models.fields.MoneyField', [], {'default': "'0.0'", 'max_digits': '12', 'decimal_places': '2', 'default_currency': "'EUR'"}),
            'rate_currency': ('djmoney.models.fields.CurrencyField', [], {'default': "'EUR'", 'max_length': '3'}),
            'vat': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['accounting.Vat']"})
        },
        'invoicing.timekeepingentry': {
            'Meta': {'ordering': "['-date']", 'object_name': 'TimeKeepingEntry'},
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['main.Relation']"}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'invoice': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['invoicing.Invoice']", 'null': 'True', 'blank': 'True'}),
            'rate': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['invoicing.TimeBillingRate']"}),
        ...
        'main.internalorder': {
            ...
            'purchase_price_indication': ('djmoney.models.fields.MoneyField', [], {'decimal_places': '5', 'default': "'0.0'", 'max_digits': '25', 'blank': 'True', 'null': 'True', 'default_currency': "'EUR'"}),
            'purchase_price_indication_currency': ('djmoney.models.fields.CurrencyField', [], {'default': "'EUR'", 'max_length': '3'}),
            'sale_order_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'selling_price': ('djmoney.models.fields.MoneyField', [], {'decimal_places': '5', 'default': "'0.0'", 'max_digits': '25', 'blank': 'True', 'null': 'True', 'default_currency': "'EUR'"}),
            'selling_price_currency': ('djmoney.models.fields.CurrencyField', [], {'default': "'EUR'", 'max_length': '3'}),
        ...
        'main.purchaseorderitem': {
            ...
            'purchase_price': ('djmoney.models.fields.MoneyField', [], {'decimal_places': '5', 'default': "'0.0'", 'max_digits': '25', 'blank': 'True', 'null': 'True', 'default_currency': "'EUR'"}),
            'purchase_price_currency': ('djmoney.models.fields.CurrencyField', [], {'default': "'EUR'", 'max_length': '3'}),
            'state': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
